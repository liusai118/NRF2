    ...
    with gzip.open(output, 'wb') as fw:
        ...
        with gzip.open(ENCODE_data, 'rt') as data:
            ...
            for row in reader:
                ...
                fw.write('SRF_H1-hESC_SRF_HudsonAlpha'.encode('utf-8'))
                fw.write('\n'.encode('utf-8'))
...
def parse_arguments(parser):
    ...
    parser.add_argument('--ENCODE_data', type=str,
                        default=workDir+'data/deepBindData/rawdata/SRF_H1-hESC_SRF_HudsonAlpha_AC.seq.gz',
                        help='path for ENCODE chip-seq data ')
    parser.add_argument('--output', type=str, default=workDir+'data/deepBindData/aftdata/SRF_H1-hESC_SRF_HudsonAlpha_AC.gz',
